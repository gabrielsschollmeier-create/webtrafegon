    ...
    cards: [
      {
        ...
        kind: 'quote',
        quote: 'Acelerar negócios & impulsionar o empreendedorismo.',
        why: 'É o motivo maior da agência existir. Tudo que a gente faz no hub serve a isso: fazer o negócio do cliente crescer.',
        how: [
          'Cada tarefa sua existe para acelerar um negócio real — não para "cumprir tabela".',
          'Quando bater a dúvida "vale a pena fazer isso?", pergunte: acelera o negócio do cliente?',
        ],
        check: 'Você liga a tarefa que está fazendo agora ao crescimento do cliente.',
      },
      {
        id: '3.2',
        title: 'Nossa Visão',
        kind: 'quote',
        quote: 'Nos tornar um grande sistema de marketing, oportuno, complexo e que gere valor a todos.',
        why: 'É aonde a gente quer chegar — e o que orienta as decisões de longo prazo.',
        how: [
          'Não é uma pessoa fazendo tudo: é um sistema que escala (hub, playbooks, base de conhecimento, IA).',
          'Gerar valor a todos = cliente, equipe e agência ganham juntos.',
        ],
        check: 'Você entende por que registrar processo (playbook/base) importa tanto quanto executar.',
      },
      {
        id: '3.3',
        title: 'Nossos Valores',
        kind: 'values',
        why: 'Oito valores. Não são frase de parede — são como a gente decide no dia a dia.',
        values: [
          { n: '01', text: 'Somos inconformados e ambiciosos',        gloss: 'Não aceitamos o "tá bom". Sempre buscamos o próximo nível.' },
          { n: '02', text: 'Alto grau de Alinhamento e Autonomia',    gloss: 'Todos sabem o objetivo; cada um executa sem precisar de babá.' },
          { n: '03', text: 'Verdade nua e crua',                       gloss: 'Feedback direto e honesto, sem rodeio — interna e externamente.' },
          { n: '04', text: 'Somos obsessivos pelo sucesso do cliente', gloss: 'O resultado do cliente vem antes do nosso conforto.' },
          { n: '05', text: 'Corremos riscos',                          gloss: 'Testar e ousar faz parte. Errar tentando é melhor que ficar parado.' },
          { n: '06', text: 'Acreditamos no mérito',                    gloss: 'Quem entrega, cresce. Resultado fala mais alto que tempo de casa.' },
          { n: '07', text: 'Fazemos mais que o combinado',             gloss: 'Entregar o mínimo não é o nosso padrão.' },
          { n: '08', text: 'Somos adultos, nem tudo será divertido',   gloss: 'Responsabilidade acima de vontade. Fazemos o que precisa ser feito.' },
        ],
        doNow: 'Escolha o valor que você mais pratica hoje e o que mais precisa melhorar.',
        check: 'Você dá um exemplo real do seu trabalho para pelo menos 3 dos 8 valores.',
      },
    ],
  },
]
