...
export const ROLE_MISSIONS = {
  ...
  'Content Creator': {
    area: 'Social Media & Comunidade',
    areaColor: '#14b8a6',
    icon: '📱',
    missions: [
      { id: 'cc-01', title: 'Publicar posts diários (5 stories + 1 post)',                        freq: 'Diário',        ons: 2, cat: 'Social Media'   },
      { id: 'cc-02', title: 'Engajamento diário — interagir em 5 perfis do nicho jurídico',       freq: 'Diário',        ons: 1, cat: 'Engajamento'    },
      { id: 'cc-03', title: 'Planejamento semanal de posts (sexta — 25 stories + 5 posts)',       freq: 'Semanal',       ons: 3, cat: 'Planejamento'   },
      { id: 'cc-04', title: 'Gestão de comunidade Advon — 1 post toda quarta',                    freq: 'Semanal',       ons: 2, cat: 'Comunidade'     },
      { id: 'cc-05', title: 'Conexão com influenciadores (5 contatos/semana — registrar planilha)',freq: 'Semanal',       ons: 3, cat: 'Relacionamento' },
      { id: 'cc-06', title: 'Social media clientes — ensinar e programar On360 (dia 20 a 25)',    freq: 'Mensal',        ons: 5, cat: 'Clientes'       },
    ],
    goals: [
      { id: 'cc-g1', icon: '📱', title: 'Posts diários publicados sem interrupção (5 stories + 1 post/dia)' },
      { id: 'cc-g2', icon: '🤝', title: '5 interações diárias em perfis do nicho jurídico' },
      { id: 'cc-g3', icon: '📆', title: 'Planejamento semanal entregue toda sexta sem falhar' },
      { id: 'cc-g4', icon: '⚖️', title: '100% das quartas com post da comunidade Advon publicado' },
      { id: 'cc-g5', icon: '🌟', title: 'Mín. 5 contatos com influenciadores por semana registrados na planilha' },
    ],
  },
}
