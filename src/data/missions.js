...
export const ROLE_MISSIONS = {
  ...
  'Creative Producer': {
    ...
    missions: [
      ...
      { id: 'cp-05', title: 'Calendário editorial Quadros e Nueva',                freq: 'Mensal',        ons: 8,  cat: 'Planejamento'  },
      ...
      { id: 'cp-09', title: 'Entregar copy de landing page Quadros e Nueva',       freq: 'Por entrega',   ons: 12, cat: 'Produção'      },
  ...
  'Marketing Trainee': {
    ...
    missions: [
      ...
      { id: 'mt-03', title: 'Atualizar Hub pós-onboarding',                        freq: 'Por entrada',   ons: 4,  cat: 'Operacional'   },
      ...
      { id: 'mt-06', title: 'Registrar observação de performance no Hub',          freq: 'Semanal',       ons: 3,  cat: 'Operacional'   },
  ...
  'Media Buyer': {
    ...
    missions: [
      ...
      { id: 'mb-04', title: 'Atualizar análise no Hub',                            freq: 'Semanal',       ons: 5,  cat: 'Análise'       },
      { id: 'mb-05', title: 'Enviar pauta de reunião 24h antes',                  freq: 'Por reunião',   ons: 4,  cat: 'Reuniões'      },
      { id: 'mb-06', title: 'Registrar otimizações realizadas no Hub',            freq: 'Semanal',       ons: 3,  cat: 'Análise'       },
  ...
  'Content Creator': {
    ...
    icon: '⚖️',
    missions: [
      { id: 'cc-01', title: 'Planejar calendário editorial Polízio e Andressa',    freq: 'Mensal (dia 25)',ons: 15, cat: 'Planejamento'  },
      { id: 'cc-02', title: 'Executar posts Polízio e Andressa',                   freq: 'Semanal',       ons: 6,  cat: 'Produção'      },
      ...
      { id: 'cc-05', title: 'Organizar perfil de redes de cliente jurídico novo',  freq: 'Por entrada',   ons: 8,  cat: 'Onboarding'    },
      { id: 'cc-06', title: 'Entregar copy de landing page Polízio e Andressa',    freq: 'Por entrega',   ons: 12, cat: 'Produção'      },
      { id: 'cc-07', title: 'Relatório mensal de métricas orgânicas Polízio e Andressa', freq: 'Mensal', ons: 10, cat: 'Análise'       },
