...
export const ROLE_MISSIONS = {
  ...
  'Creative Producer': {
    ...
    missions: [
      ...
      { id: 'cp-04', title: 'Planejamento mensal Quadros + Nueva',                 freq: 'Mensal',        ons: 5,  cat: 'Planejamento'  },
      { id: 'cp-05', title: 'Calendário editorial Quadros e Nueva',                freq: 'Mensal',        ons: 4,  cat: 'Planejamento'  },
  ...
  'Marketing Trainee': {
    ...
    icon: '📈',
    missions: [
      { id: 'mt-01', title: 'Configurar Google Meu Negócio de cliente novo',       freq: 'Por entrada',   ons: 5,  cat: 'Onboarding'    },
      { id: 'mt-02', title: 'Organizar perfil de redes sociais de cliente novo',   freq: 'Por entrada',   ons: 4,  cat: 'Onboarding'    },
      { id: 'mt-03', title: 'Atualizar Hub pós-onboarding',                        freq: 'Por entrada',   ons: 2,  cat: 'Operacional'   },
      { id: 'mt-04', title: 'Estudar e praticar gestão de tráfego pago',           freq: 'Semanal',       ons: 3,  cat: 'Crescimento'   },
      { id: 'mt-05', title: 'Acompanhar campanha com Tochiro / GS',                freq: 'Semanal',       ons: 3,  cat: 'Crescimento'   },
  ...
  'Media Buyer': {
    ...
    missions: [
      ...
      { id: 'mb-02', title: 'Enviar relatório de performance para clientes',       freq: 'Quinzenal',     ons: 5,  cat: 'Relatório'     },
      { id: 'mb-03', title: 'Conduzir reunião quinzenal com cliente',              freq: 'Quinzenal',     ons: 4,  cat: 'Reuniões'      },
      { id: 'mb-04', title: 'Atualizar análise no Hub',                            freq: 'Semanal',       ons: 3,  cat: 'Análise'       },
      { id: 'mb-05', title: 'Enviar pauta de reunião 24h antes',                  freq: 'Por reunião',   ons: 2,  cat: 'Reuniões'      },
      { id: 'mb-06', title: 'Registrar otimizações realizadas no Hub',            freq: 'Semanal',       ons: 2,  cat: 'Análise'       },
  ...
  'Content Creator': {
    ...
    icon: '⚖️',
    missions: [
      { id: 'cc-01', title: 'Planejar calendário editorial Polízio e Andressa',    freq: 'Mensal (dia 25)',ons: 8,  cat: 'Planejamento'  },
      { id: 'cc-02', title: 'Executar posts Polízio e Andressa',                   freq: 'Semanal',       ons: 3,  cat: 'Produção'      },
      { id: 'cc-03', title: 'Planejamento mensal Polízio + Andressa',              freq: 'Mensal',        ons: 5,  cat: 'Planejamento'  },
      { id: 'cc-04', title: 'Configurar GMB de cliente jurídico novo',             freq: 'Por entrada',   ons: 5,  cat: 'Onboarding'    },
      { id: 'cc-05', title: 'Organizar perfil de redes de cliente jurídico novo',  freq: 'Por entrada',   ons: 4,  cat: 'Onboarding'    },
