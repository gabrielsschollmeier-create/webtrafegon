...
export const erpClients = [
  ...
  { id: 'jessica_cinigaglia', name: 'Jessica Cinigaglia',       clientType: 'destrava_digital', color: '#ec4899', manager: 'gs',  status: 'active', since: '2026-09-05', monthlyValue: 0, niche: 'Imobiliário' },
]
