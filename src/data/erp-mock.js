...
export const collaborators = [
  ...
  },
  {
    ...
    level: 2, rank: 'Silver Leader', xp: 1400, xpToNext: 2500,
    streak: 4, tasksCompleted: 22, tasksThisMonth: 6,
    since: '2026-05-23',
    deliveriesByType: { lp: 2, criativo: 1, campanha: 3, copy: 5, video: 0, reuniao: 8 },
    badges: ['🔑', '📋'],
  },
  {
    id: 'tochiro', name: 'Tochiro', email: 'gestaotrafegon@gmail.com',
    role: 'Gestor de Tráfego', avatar: 'TO', color: '#22d3ee',
    level: 2, rank: 'Rising Pro', xp: 980, xpToNext: 2000,
    streak: 3, tasksCompleted: 18, tasksThisMonth: 5,
    since: '2026-05-23',
    deliveriesByType: { lp: 3, criativo: 1, campanha: 7, copy: 1, video: 0, reuniao: 3 },
    badges: ['🚀', '⚡'],
  },
  {
    id: 'ana_sm', name: 'Ana', email: 'socialmediatrafegon@gmail.com',
    role: 'Social Media', avatar: 'AN', color: '#ec4899',
    level: 2, rank: 'Content Star', xp: 860, xpToNext: 2000,
    streak: 5, tasksCompleted: 15, tasksThisMonth: 7,
    since: '2026-05-23',
    deliveriesByType: { lp: 1, criativo: 10, campanha: 0, copy: 6, video: 2, reuniao: 2 },
    badges: ['🎨', '✨'],
  },
  {
    id: 'adm_at', name: 'ADM', email: 'atendimentotrafegon@gmail.com',
    role: 'Atendimento', avatar: 'AD', color: '#f59e0b',
    level: 1, rank: 'Team Player', xp: 420, xpToNext: 1000,
    streak: 2, tasksCompleted: 9, tasksThisMonth: 3,
    since: '2026-05-23',
    deliveriesByType: { lp: 0, criativo: 0, campanha: 1, copy: 2, video: 0, reuniao: 6 },
    badges: ['🤝'],
  },
  {
    id: 'juliano', name: 'Juliano', email: 'trafegonvendas@gmail.com',
    role: 'Vendas', avatar: 'JU', color: '#a78bfa',
    level: 1, rank: 'Hunter', xp: 310, xpToNext: 1000,
    streak: 1, tasksCompleted: 6, tasksThisMonth: 2,
    since: '2026-05-23',
    deliveriesByType: { lp: 0, criativo: 0, campanha: 0, copy: 3, video: 0, reuniao: 4 },
    badges: ['🎯'],
  },
]
