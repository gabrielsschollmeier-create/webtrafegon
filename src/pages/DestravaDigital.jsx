...
const ATIVACAO_SLIDES = [
  ...
  },
  {
    ...
    subtitle: 'Cinco missões com prazo, entregável e consequência',
    missions: [
      { day: 3,  icon: '📱', title: 'Primeira resposta documentada', evidence: 'Print da conversa' },
      { day: 5,  icon: '📊', title: 'Leia seus números',             evidence: 'Print do gerenciador' },
      { day: 8,  icon: '🎯', title: 'Separe o joio do trigo',        evidence: 'Resposta via WhatsApp' },
      { day: 12, icon: '📋', title: 'Monte seu registro',            evidence: 'Planilha ou lista' },
      { day: 14, icon: '🏁', title: 'Balanço final',                 evidence: 'Texto escrito + call' },
    ],
  },
  {
    type: 'mission',
  ...
  {
    type: 'mission',
    day: 5, number: 2, icon: '📊', deadline: 'Dia 5 e Dia 8',
    title: 'Missões 2 e 3 — Números e Perfil',
    instruction: 'Dia 5: Acesse o gerenciador e me mande print com impressões, cliques e leads. Dia 8: Me diga quais leads eram do perfil ideal e o que tinham em comum.',
    evidence: 'Dia 5: print do gerenciador. Dia 8: resposta no WhatsApp.',
    extra: [
      { icon: '⚙️', text: 'Ajuste A: CPL alto → reduz orçamento 20% + troca criativo' },
      { icon: '🎯', text: 'Ajuste B: Leads errados → restringe público por cidade/idade' },
      { icon: '📘', text: 'Ajuste C: Facebook sem resultado → remove dos posicionamentos' },
    ],
    why: 'Sem dados da sua boca, ajustamos no escuro.',
    color: '#60a5fa',
  },
  {
    type: 'adjustments_ref',
    title: 'Quando Algo Não Estiver Certo',
    subtitle: 'Não mexa sem nos chamar — aqui está o que fazemos em cada situação',
    adjustments: [
      { code: 'A', situation: 'CPL acima da meta desde o início',        action: 'Reduz orçamento 20% + troca o criativo' },
      { code: 'B', situation: 'Leads chegando mas perfil errado',        action: 'Restringe público por cidade, idade ou interesse' },
      { code: 'C', situation: 'Facebook gastando sem converter',         action: 'Remove Facebook dos posicionamentos, mantém Instagram' },
      { code: 'D', situation: 'Criativo gastou +R$40 sem nenhum lead',  action: 'Pausa o anúncio imediatamente pelo toggle' },
      { code: 'E', situation: 'Um criativo muito melhor que os outros', action: 'Pausa os demais, aumenta orçamento do vencedor 30%' },
    ],
    note: 'Passo a passo completo no Guia de Gestão enviado após esta sessão',
  },
  {
    type: 'mission',
    day: 12, number: 4, icon: '📋', deadline: 'Dias 12 e 14',
    title: 'Missões 4 e 5 — Registro e Balanço',
    instruction: 'Dia 12: Crie uma planilha ou lista com nome do lead, data de entrada e se virou consulta. Dia 14: me mande total de leads, consultas e fechamentos antes da nossa call.',
    evidence: 'Dia 12: planilha ou lista enviada. Dia 14: balanço escrito no WhatsApp.',
    extra: [
      { icon: '💡', text: 'Quem chega na call de encerramento sem o balanço perde metade do tempo' },
    ],
    why: 'O registro transforma o caos de mensagens em dado real.',
    color: '#ea8a29',
  },
  {
    type: 'clock',
    ...
    plan: '15 dias',
    warning: 'Cada missão não entregue é um dado que não coletamos. Sem dado, sem ajuste. Sem ajuste, resultado fraco.',
    actions: [
      'Missão não entregue no prazo = suporte aquele ponto não acontece',
      'Campanha pausada sem aviso = leads zerados sem motivo',
      'Suporte encerra no dia combinado, independente de quanto foi usado',
    ],
  ...
  return (
    <div className="flex flex-col justify-center h-full px-8 lg:px-16 max-w-4xl mx-auto w-full">
      ...
      <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.8 }}
        ...
        Cada missão tem prazo, entregável obrigatório e consequência se não for cumprida
      </motion.p>
    </div>
  )
}
