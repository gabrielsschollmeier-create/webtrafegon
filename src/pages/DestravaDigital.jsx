...
const ATIVACAO_SLIDES = [
  ...
  },
  {
    ...
    instruction: 'Responda o 1° lead que chegar em até 1h do recebimento. Cronometra o tempo real. Escreva um script de 3 linhas: o que você diz assim que o lead chega.',
...
const ESTRUTURACAO_SLIDES = [
  ...
  },
  {
    ...
    day: 2, number: 1, icon: '📱', deadline: 'Dia 2',
    title: 'Missão 1 — Primeira Resposta',
    instruction: 'Responda o 1° lead que chegar em até 1h do recebimento. Cronometra o tempo real. Escreva um script de 3 linhas de abordagem — o que você diz assim que o lead chega.',
    evidence: 'Print da conversa + script enviado no WhatsApp.',
    why: 'Velocidade de resposta define se o lead vira consulta ou some. O script garante consistência toda vez — independente do canal de origem.',
    color: GREEN,
  },
  {
    type: 'mission',
