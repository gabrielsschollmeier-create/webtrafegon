...
// ─── ATIVAÇÃO META ────────────────────────────────────────────────────────────
const ATIVACAO_META_SLIDES = [
  // BLOCO 1 — Abertura
  { type: 'cover', title: 'Destrava Digital', subtitle: 'Meta Ads · 1h30', badge: 'Ativação Meta' },
  {
    type: 'four_ps',
    ...
    brain: { icon: '🧠', label: 'Estratégia', desc: "Define posicionamento, público, objetivos e como os 4 P's se conectam para gerar resultado consistente" },
    ps: [
      { icon: '🎁', label: 'Produto', desc: 'O que você entrega', items: ['Proposta de valor', 'Qualidade e diferencial', 'Experiência de entrega', 'Atendimento e pós-venda', 'Prova social / depoimentos'] },
      { icon: '💰', label: 'Preço', desc: 'Como você se posiciona', items: ['Posicionamento de preço', 'Condições de pagamento', 'Pacotes e combos', 'Ancoragem de valor', 'Garantias e risco zero'] },
      { icon: '📍', label: 'Praça', desc: 'Onde você opera', items: ['Loja física / presencial', 'Canal digital próprio', 'WhatsApp e direto', 'Marketplaces', 'Parceiros e revendedores', 'Eventos e feiras'] },
      { icon: '📢', label: 'Promoção', desc: 'Como você aparece', highlight: true, items: ['SEO e orgânico', 'Conteúdo e redes sociais', 'E-mail / CRM', 'Influência e PR', 'Tráfego pago', 'Mídia offline (TV, rádio)', 'Indicação e boca a boca'], highlightItem: 'Tráfego pago' },
    ],
  ...
  },
  {
    ...
    insights: [
      ...
      'Quem não aparece no feed no momento certo, simplesmente não existe para esse cliente',
    ],
  },
  { type: 'steps', title: 'O que acontece hoje', items: ['A lógica dos anúncios no Meta Ads', 'Validar o que foi construído no Meta Ads', 'Aprender a ler os principais indicadores e quando e como otimizar', 'Seu guia operacional para os próximos 15 dias'], duration: '1h30' },
  // BLOCO 2 — Lógica Meta
  {
    type: 'metrics',
    title: 'Meta Ads — A lógica da interrupção',
    metrics: [
      { label: 'Meta = Atenção', icon: '📲', desc: 'Interrompe quem ainda não sabe que quer. Você cria o desejo e a necessidade antes da busca existir.' },
      { label: 'Feed e Reels', icon: '📸', desc: 'Seu cliente está rolando o feed — o criativo certo para o scroll e gera interesse antes da necessidade ser consciente.' },
      { label: 'Conversão direta', icon: '🚀', desc: 'Do anúncio ao WhatsApp em um clique — sem landing page extra, sem atrito para o lead entrar em contato.' },
    ],
    note: 'O poder do Meta: chegar no cliente antes que ele saiba que precisa de você.',
  },
  {
    type: 'funnel',
    title: 'Da internet à compra',
    subtitle: 'Cada etapa filtra — só os mais qualificados chegam ao final',
    channels: [{ icon: '📸', name: 'Meta Ads', color: '#be29ec', desc: 'gera atenção e interrompe' }],
    funnel: ['Anúncio', 'Visualização', 'Clique', 'Lead', 'Lead qualificado', 'Cliente'],
    continuous: 'Otimização contínua',
    leftZones: [
      { label: 'Gerar atenção', sub: 'Meta Ads', steps: 3, color: '#be29ec' },
  ...
  // BLOCO 3 — Meta Ads
  {
    type: 'google_intro', platform: '🟣 Meta Ads', platformColor: '#be29ec',
  ...
  {
    type: 'platform', platform: '🟣 Meta Ads', platformColor: '#be29ec',
  ...
  {
    type: 'practice', platform: '🟣 Meta Ads', platformColor: '#be29ec',
  ...
  {
    type: 'routines', platform: '🟣 Meta Ads', platformColor: '#be29ec',
    title: 'Ações do dia a dia — Meta Ads',
    routines: [
      { icon: '➕', title: 'Criar uma campanha nova', steps: ['Clique em "+ Criar" no Gerenciador de Anúncios', 'Escolha o objetivo adequado ao que você quer gerar', 'Configure orçamento, datas e crie o conjunto de anúncios', 'Adicione o anúncio com criativo e texto → publique'] },
      { icon: '✅', title: 'Ativar um novo anúncio', steps: ['Acesse a campanha → abra o conjunto de anúncios ativo', 'Clique em "+ Adicionar anúncio"', 'Suba o criativo (imagem, arte ou vídeo) e escreva o texto', 'Revise o botão de ação → publique'] },
      { icon: '⏸️', title: 'Pausar um conjunto de anúncios', steps: ['No Gerenciador, clique na campanha ativa', 'Localize o conjunto que deseja parar', 'Clique no botão de status → fica cinza (pausado)', 'O anúncio para de veicular imediatamente'] },
      { icon: '📋', title: 'Duplicar conjunto para teste', steps: ['Clique nos "..." ao lado do conjunto', 'Selecione "Duplicar"', 'No novo conjunto, altere o público ou o criativo', 'Ative e compare os resultados após 3 dias'] },
    ],
  },
  // BLOCO 4 — Regras e decisões
  {
    type: 'list',
    title: 'Regras que governam as campanhas',
    items: [
      'O criativo é o maior alavancador de resultado no Meta — a mesma verba com criativo melhor gera mais leads',
      ...
      'Anúncio que ninguém clica não é problema de orçamento — é problema de mensagem ou criativo',
      'A oferta precisa ser clara nos primeiros 3 segundos do criativo',
  ...
  },
  {
    ...
    groups: [
      { category: 'Custo', icon: '💰', color: '#f59e0b', items: [
        { situation: 'CPL alto desde o início', action: 'Reduz orçamento 20% e revisa criativos — não aumenta pressão sem dado', tag: 'Ajustar' },
        { situation: 'CPM alto com CTR do link baixo', action: 'Criativo não engaja ou público pequeno demais — expandir ou revisar copy', tag: 'Ajustar' },
      ...
      { category: 'Leads', icon: '🎯', color: '#60a5fa', items: [
        ...
        { situation: 'Volume de leads zerou', action: 'Checar se campanha está ativa, verba disponível antes de agir', tag: 'Checar' },
      ...
      { category: 'Conversão', icon: '📞', color: '#6eda2c', items: [
      ...
      { category: 'Criativo', icon: '🎨', color: '#be29ec', items: [
        { situation: 'CTR do link abaixo de 1%', action: 'Testar novo criativo, thumbnail ou gancho nos primeiros segundos do vídeo', tag: 'Ajustar' },
        { situation: 'Frequência acima de 3–4', action: 'Público saturando — trocar criativo ou expandir segmentação', tag: 'Pausar' },
      ...
      { category: 'Algoritmo', icon: '⚡', color: '#f472b6', items: [
        ...
        { situation: 'Conversões pararam de registrar', action: 'Verificar se pixel está ativo — sem rastreamento o algoritmo fica cego', tag: 'Checar' },
      ]},
    ],
  ...
  // BLOCO 5 — CPL Limite
  {
    ...
    metrics: [
      { label: 'CPL', desc: 'Custo por lead — o número que decide se a campanha está dando retorno. Definimos o seu CPL meta agora.' },
      { label: 'CTR (link)', desc: 'Taxa de clique no link. Abaixo de 1%: criativo não para o scroll ou não gera intenção de clique.' },
      { label: 'CPM', desc: 'Custo por mil impressões — indica o custo de chegar às pessoas. CPM alto com pouco clique = criativo não engaja ou público pequeno.' },
      { label: 'Frequência', desc: 'Quantas vezes em média a mesma pessoa viu o anúncio. Acima de 3–4: público saturando — trocar criativo ou expandir.' },
    ],
  ...
  },
  {
    ...
    example: { items: ['Ticket R$3.000 · margem 50% = R$1.500 por cliente', 'Fecha 1 a cada 20 leads', 'CPV máximo: R$ 1.500', 'CPL limite = R$1.500 ÷ 20'], result: '→ CPL máximo aceitável: R$ 75' },
  ...
  {
    type: 'rules',
    platform: '📅 Rotina de Operação — Meta Ads',
    title: 'Rotinas básicas',
    dos: [
      'Todo dia, 5 min: confirmar que campanhas estão ativas e entregando — gasto real vs meta diária',
      'Segunda-feira, 20–30 min: Frequência acima de 3–4 → trocar criativo; CTR do link <1% → novo criativo',
      'Segunda-feira: CPL acima da meta → analisar criativos e conjuntos por dia; qual combinação drena verba sem lead?',
      ...
      'A cada 15 dias: revisar criativos em teste → pausar o perdedor e publicar próxima variação',
    ],
    donts: [
  ...
  // BLOCO 8 — Próximos 15 dias
  {
    type: 'plan_intro',
    title: 'Seus próximos 15 dias',
    subtitle: 'Meta Ads ativo, suporte aberto e um plano — ',
    subtitleHighlight: 'o foco é criar ritmo e entender o que está chegando.',
    points: [
      { icon: '✅', text: 'Meta Ads no ar' },
      { icon: '📋', text: 'Cinco missões distribuídas em 15 dias' },
      { icon: '⏱️', text: 'Suporte ativo até o dia 15' },
      { icon: '🎥', text: 'Acompanhamento da campanha incluso' },
    ],
    alert: 'Os primeiros 15 dias definem o ritmo. Quem não age nesse período paga por cliques sem saber o que está acontecendo.',
  },
  {
    ...
    missions: [
      ...
      { day: 5,  icon: '📊', title: 'Primeiros números lidos',        evidence: 'Print do gerenciador' },
      { day: 8,  icon: '🎯', title: 'Qualidade do lead mapeada',      evidence: 'Lista com classificação' },
      { day: 12, icon: '🔍', title: 'Primeira limpeza — Meta',        evidence: 'Lista de conjuntos e criativos fracos' },
      { day: 15, icon: '🏁', title: 'Balanço da quinzena',            evidence: 'Texto antes da call' },
    ],
  },
  { type: 'mission', day: 5, number: 1, icon: '📱', deadline: 'Dia 5', color: GREEN, title: 'Missão 1 — Primeira Resposta', instruction: 'Responda os 5 primeiros leads em até 20min após a chegada. Cronometra o tempo real de cada um e registra.', evidence: 'Print das 5 conversas com horário de chegada e horário de resposta visíveis.', why: 'Velocidade de resposta define se o lead vira consulta ou some. 20min é o limite — depois disso a chance de conversão cai drasticamente.' },
  ...
  // BLOCO FINAL — Glossário
  {
    ...
    subtitle: 'Referência rápida para entender as métricas, a estrutura e o vocabulário do Meta Ads',
    terms: [
      ...
      { term: 'CTR (link)',       color: '#4285f4', def: 'Taxa de clique no link do anúncio — mede o quanto o criativo leva ao clique' },
      ...
      { term: 'Frequência',       color: '#be29ec', def: 'Quantas vezes em média a mesma pessoa viu o anúncio — acima de 3-4, hora de renovar criativo' },
      ...
      { term: 'Público-alvo',     color: '#6eda2c', def: 'Segmentação de pessoas que verão os anúncios — região, idade, interesses' },
...
// ─── ATIVAÇÃO GOOGLE ──────────────────────────────────────────────────────────
const ATIVACAO_GOOGLE_SLIDES = [
  // BLOCO 1 — Abertura
  { type: 'cover', title: 'Destrava Digital', subtitle: 'Google Ads · 1h30', badge: 'Ativação Google' },
  {
    type: 'four_ps',
    title: "Marketing é muito mais do que anúncios",
    subtitle: "O cérebro estratégico define o jogo — os 4 P's são como ele age no mercado",
  ...
  },
  {
    ...
    insights: [
      ...
      '180 milhões de brasileiros têm acesso à internet — mais da metade da população comprando online',
      'Brasileiro passa em média 9h por dia online — maior tempo do mundo entre países pesquisados',
      'Quem não aparece na busca no momento certo, simplesmente não existe para esse cliente',
    ],
  },
  { type: 'steps', title: 'O que acontece hoje', items: ['A lógica dos anúncios no Google Ads', 'Validar o que foi construído no Google Ads', 'Aprender a ler os principais indicadores e quando e como otimizar', 'Seu guia operacional para os próximos 15 dias'], duration: '1h30' },
  // BLOCO 2 — Lógica Google
  {
    type: 'metrics',
    title: 'Google Ads — A lógica da intenção',
    metrics: [
      { label: 'Google = Intenção', icon: '🔍', desc: 'Captura quem já está procurando. O cliente digitou a busca — você aparece no momento certo.' },
      { label: 'Pesquisa ativa', icon: '🎯', desc: 'O cliente tem uma necessidade e está buscando solução agora — a maior intenção de compra existente.' },
      { label: 'Clique qualificado', icon: '🚀', desc: 'Quem clica já demonstrou interesse. O desafio não é parar o scroll — é ser o resultado mais relevante.' },
    ],
    note: 'O poder do Google: aparecer para quem já quer comprar — no momento exato da decisão.',
  },
  {
    type: 'funnel',
    title: 'Da internet à compra',
    subtitle: 'Cada etapa filtra — só os mais qualificados chegam ao final',
    channels: [{ icon: '🔍', name: 'Google Ads', color: '#4285f4', desc: 'captura intenção ativa' }],
    funnel: ['Anúncio', 'Busca', 'Clique', 'Lead', 'Lead qualificado', 'Cliente'],
    continuous: 'Otimização contínua',
    leftZones: [
      { label: 'Capturar intenção', sub: 'Google Ads', steps: 3, color: '#4285f4' },
      { label: 'Converter', sub: 'Vendas', steps: 3, color: '#6eda2c' },
    ],
    highlight: 'Tráfego sem atendimento = verba jogada fora.\nAtendimento sem tráfego = sem volume para fechar.',
  },
  // BLOCO 3 — Google Ads
  {
    type: 'google_intro', platform: '🔵 Google Ads', platformColor: '#4285f4',
  ...
  {
    type: 'platform', platform: '🔵 Google Ads', platformColor: '#4285f4',
  ...
  {
    type: 'practice', platform: '🔵 Google Ads', platformColor: '#4285f4',
  ...
  {
    type: 'routines', platform: '🔵 Google Ads', platformColor: '#4285f4',
    title: 'Ações do dia a dia — Google Ads',
    routines: [
      { icon: '🛡️', title: 'Negativar um termo de pesquisa', steps: ['Abra a campanha → clique em "Termos de pesquisa"', 'Identifique buscas que não têm relação com o negócio', 'Selecione o termo → clique em "Adicionar como negativo"', 'Escolha o nível: campanha ou grupo de anúncios'] },
      { icon: '⏸️', title: 'Pausar ou ativar um anúncio', steps: ['Vá em Campanhas → Grupos de anúncios → Anúncios', 'Localize o anúncio que deseja alterar', 'Clique no botão de status (verde = ativo / cinza = pausado)', 'A mudança é imediata — não precisa salvar'] },
      { icon: '➕', title: 'Criar uma campanha nova', steps: ['Clique em "+ Nova campanha" e escolha o objetivo (Leads)', 'Configure nome, orçamento diário e localização', 'Adicione o grupo de anúncios com keywords e anúncio RSA', 'Publique e aguarde análise do Google (até 24h)'] },
      { icon: '💰', title: 'Ajustar o orçamento', steps: ['Clique na campanha → aba "Configurações"', 'Localize "Orçamento diário médio" e edite o valor', 'Salve — a mudança entra em vigor no mesmo dia', 'Aguarde 24h para o algoritmo se recalibrar'] },
    ],
  },
  // BLOCO 4 — Regras e decisões
  {
    ...
    items: [
      ...
      'Keywords muito genéricas atraem buscas irrelevantes e inflam o custo — negativar é a defesa do orçamento',
      'Leads baratos e ruins custam mais caro que leads caros e qualificados — volume não é qualidade',
      'Teste de título RSA não é opcional — o algoritmo precisa de variação para encontrar o melhor texto',
      'R$20/dia constante bate R$40 intenso por poucos dias — o algoritmo precisa de sinal contínuo',
      'Mexer antes de ter dados suficientes é sabotar a própria campanha',
      'Anúncio que ninguém clica não é problema de orçamento — é problema de título ou relevância',
      'A oferta precisa ser clara no título — é o que aparece primeiro na busca',
      'Campanha boa com atendimento ruim = verba desperdiçada — o anúncio abre a porta, você fecha a venda',
    ],
  },
  {
    ...
    groups: [
      ...
      { category: 'Leads', icon: '🎯', color: '#60a5fa', items: [
        { situation: 'Muitos cliques, poucos leads', action: 'Anúncio funciona — problema na landing page, formulário ou WhatsApp', tag: 'Checar' },
        { situation: 'Leads chegam mas sem perfil ideal', action: 'Tráfego desqualificado — revisar keywords, negativos e copy do anúncio', tag: 'Ajustar' },
      ...
      { category: 'Criativo', icon: '🎨', color: '#be29ec', items: [
        { situation: 'CTR abaixo de 3%', action: 'Testar novo headline ou título no RSA — a mensagem não chama atenção na busca', tag: 'Ajustar' },
        { situation: 'Keyword com CPL muito acima da meta por 7+ dias', action: 'Pausa e avalia virar negativo — não pausar por valor fixo, mas por dado', tag: 'Pausar' },
        { situation: 'Termos de pesquisa irrelevantes consumindo verba', action: 'Negativar imediatamente — toda semana checar a aba Termos de Pesquisa', tag: 'Ajustar' },
      ]},
      { category: 'Algoritmo', icon: '⚡', color: '#f472b6', items: [
        ...
        { situation: 'CPL alto na 1ª semana de campanha nova', action: 'Normal — fase de aprendizado. Avalie só após 50+ cliques ou 7 dias', tag: 'Aguardar' },
        { situation: 'Performance caiu após aumento de orçamento', action: 'Mudança brusca reinicia o aprendizado — nunca mais de 20% a cada 3–4 dias', tag: 'Checar' },
        { situation: 'Conversões pararam de registrar', action: 'Verificar se tag de conversão está ativa — sem rastreamento o algoritmo fica cego', tag: 'Checar' },
      ]},
    ],
    note: 'Decisão só com dados suficientes — volume pequeno não permite conclusão confiável',
  },
  // BLOCO 5 — CPL Limite
  {
    ...
    metrics: [
      { label: 'CPL', desc: 'Custo por lead — o número que decide se a campanha está dando retorno. Definimos o seu CPL meta agora.' },
      { label: 'CTR', desc: 'Taxa de clique. Abaixo de 3%: título não chama atenção ou anúncio não é relevante para a busca.' },
      { label: 'CPM', desc: 'Custo por mil impressões — no Google Pesquisa, foque mais em CPC e CPL como indicadores principais.' },
      { label: 'CPC', desc: 'Custo por clique — quanto você paga a cada clique. Referência para calibrar o lance e controlar o gasto.' },
    ],
    note: 'Impressões e alcance não pagam conta — CPL e conversão sim',
    obs: 'Com volume mínimo de dados (30–50 leads), vale começar a olhar o CPLQ — Custo por Lead Qualificado. É ele que conecta o tráfego com a realidade do seu processo de vendas.',
  },
  ...
  // BLOCO 6 — Rotina Google
  {
    type: 'rules',
    platform: '📅 Rotina de Operação — Google Ads',
    title: 'Rotinas básicas',
    dos: [
      'Todo dia, 5 min: confirmar que campanhas estão ativas e entregando — gasto real vs meta diária',
      'Segunda-feira, 20–30 min: Termos de pesquisa → negativar tudo que apareceu e não faz sentido; sem limite de quantidade',
      'Segunda-feira: CTR abaixo de 3% → testar novo título RSA; keyword com 2x CPL meta há 7 dias → pausar e avaliar',
      'Quarta-feira, 15 min: comparar CPL acumulado vs semana anterior; checar se há lead sem retorno há +24h',
      'Sexta-feira, 20 min: registrar CPL semanal, volume de leads e o que foi testado — anotar aprendizado',
      'A cada 15 dias: revisar keywords — pausar as que drenam sem converter; testar nova variação de título RSA',
    ],
    donts: [
      { rule: 'Tratar impressões e cliques como resultado', why: 'Métricas de vaidade não pagam conta — CPL e conversão são os únicos que importam' },
      { rule: 'Pausar keyword antes de ter dado suficiente', why: 'Toda keyword precisa de tempo mínimo rodando — decisão prematura descarta o que poderia funcionar' },
      { rule: 'Ignorar a aba Termos de Pesquisa por semanas', why: 'Buscas irrelevantes drenam orçamento silenciosamente — cada semana sem negativar é verba desperdiçada' },
      { rule: 'Pausar campanha quando achar caro sem analisar o CPL', why: 'Custo sem contexto não significa nada — o que importa é quanto custa cada lead, não o gasto total' },
      { rule: 'Mudar orçamento todo dia baseado na ansiedade do momento', why: 'Oscilação constante impede o algoritmo de estabilizar — consistência gera aprendizado' },
      { rule: 'Não fazer follow-up em lead que não respondeu', why: 'A maioria dos leads precisa de mais de um contato para avançar — silêncio não é rejeição' },
    ],
  ...
  // BLOCO 8 — Próximos 15 dias
  {
    type: 'plan_intro',
    title: 'Seus próximos 15 dias',
    subtitle: 'Google Ads ativo, suporte aberto e um plano — ',
    subtitleHighlight: 'o foco é criar ritmo e entender o que está chegando.',
    points: [
      { icon: '✅', text: 'Google Ads no ar' },
      { icon: '📋', text: 'Cinco missões distribuídas em 15 dias' },
      { icon: '⏱️', text: 'Suporte ativo até o dia 15' },
      { icon: '🎥', text: 'Acompanhamento da campanha incluso' },
    ],
  ...
  },
  {
    ...
    missions: [
      ...
      { day: 5,  icon: '📊', title: 'Primeiros números lidos',         evidence: 'Print do gerenciador' },
      { day: 8,  icon: '🎯', title: 'Qualidade do lead mapeada',       evidence: 'Lista com classificação' },
      { day: 12, icon: '🔍', title: 'Primeira limpeza — Google',       evidence: 'Lista de termos de pesquisa negativados' },
      { day: 15, icon: '🏁', title: 'Balanço da quinzena',             evidence: 'Texto antes da call' },
    ],
  },
  { type: 'mission', day: 5, number: 1, icon: '📱', deadline: 'Dia 5', color: GREEN, title: 'Missão 1 — Primeira Resposta', instruction: 'Responda os 5 primeiros leads em até 20min após a chegada. Cronometra o tempo real de cada um e registra.', evidence: 'Print das 5 conversas com horário de chegada e horário de resposta visíveis.', why: 'Velocidade de resposta define se o lead vira consulta ou some. 20min é o limite — depois disso a chance de conversão cai drasticamente.' },
  { type: 'mission', day: 5, number: 2, icon: '📊', deadline: 'Dia 5', color: '#60a5fa', title: 'Missão 2 — Primeiros Números', instruction: 'Acesse o Google Ads e registre: investimento total, impressões, cliques, leads e CPL. Compare o CPL real com o CPL limite que você calculou na consultoria.', evidence: 'Print do gerenciador com as métricas marcadas.', why: 'Quem não sabe ler o número fica dependente de terceiros para sempre. Esse é o hábito semanal que você vai carregar daqui pra frente.' },
  { type: 'mission', day: 8, number: 3, icon: '🎯', deadline: 'Dia 8', color: '#a78bfa', title: 'Missão 3 — Qualidade do Lead', instruction: 'Classifique cada lead recebido: quente, morno ou fora do perfil. Identifique o que os bons leads têm em comum — região, problema, urgência. Faça 1 follow-up em leads que não responderam após 48h.', evidence: 'Lista com classificação enviada no WhatsApp.', why: 'Sem esse filtro você vai otimizar para CPL baixo e fechar pouco. Qualidade de lead define qualidade de resultado.' },
  { type: 'mission', day: 12, number: 4, icon: '🔍', deadline: 'Dia 12', color: '#f59e0b', title: 'Missão 4 — Primeira Limpeza', instruction: 'Abra a aba Termos de Pesquisa no Google Ads. Identifique todas as buscas que apareceram e não têm relação com o seu negócio. Negativize tudo — sem limite de quantidade, quanto mais limpo melhor.', evidence: 'Lista dos termos negativados enviada — eu reviso e completo em até 24h.', why: 'Todo orçamento tem vazamento. Negativar termos irrelevantes nas primeiras semanas é o ajuste de maior impacto na qualidade dos leads.' },
  { type: 'mission', day: 15, number: 5, icon: '🏁', deadline: 'Dia 15', color: GREEN, title: 'Missão 5 — Balanço da Quinzena', instruction: 'Escreva: total de leads recebidos, perfil predominante dos que chegaram, principal dificuldade no atendimento. O que funcionou? O que não funcionou? O que quer testar?', evidence: 'Texto enviado antes da call de encerramento — sem ele, a call não acontece.', why: 'Quem faz o balanço por escrito entra na call com clareza. Quem não faz gasta metade do tempo relembrando o que aconteceu.' },
  { type: 'clock', title: 'O Relógio Está Correndo', plan: '15 dias', warning: 'Cada missão não entregue é um dado que não coletamos. Sem dado, a call de encerramento não serve para nada.', actions: ['Missão não entregue no prazo = suporte daquele ponto não acontece', 'Campanha pausada sem aviso = leads zerados sem motivo', 'Suporte encerra no dia 15, independente de quanto foi usado'], cta: 'Dúvida? Me chame agora — não depois do suporte acabar.' },
  // BLOCO FINAL — Glossário
  {
    type: 'glossary',
    title: 'Glossário — termos que você vai encontrar',
    subtitle: 'Referência rápida para entender as métricas, a estrutura e o vocabulário do Google Ads',
    terms: [
      { term: 'Lead',              color: '#6eda2c', def: 'Pessoa que demonstrou interesse e deixou contato' },
      { term: 'Lead qualificado',  color: '#6eda2c', def: 'Lead com perfil e intenção compatíveis com o seu serviço' },
      { term: 'CPL',               color: '#6eda2c', def: 'Custo por Lead — quanto custou gerar cada lead' },
      ...
      { term: 'Pmax',              color: '#be29ec', def: 'Performance Max — campanha que distribui em todos os canais Google automaticamente' },
      { term: 'Remarketing',       color: '#6eda2c', def: 'Anunciar para quem já interagiu com o negócio antes' },
      { term: 'Algoritmo',         color: '#6eda2c', def: 'Sistema que decide para quem, quando e onde mostrar o anúncio' },
      { term: 'Conversão',         color: '#6eda2c', def: 'Ação concluída: lead, clique no WhatsApp ou formulário preenchido' },
    ],
...
const FORMATS = [
  {
    id: 'ativacao_meta',
    title: 'Ativação Meta',
    subtitle: '1 plataforma · Meta Ads',
    duration: '1h30',
    color: '#be29ec',
    icon: Zap,
    slides: ATIVACAO_META_SLIDES,
  },
  {
    id: 'ativacao_google',
    title: 'Ativação Google',
    subtitle: '1 plataforma · Google Ads',
    duration: '1h30',
    color: '#4285f4',
    icon: Zap,
    slides: ATIVACAO_GOOGLE_SLIDES,
  },
  {
    id: 'estruturacao',
            ...
            return (
              <motion.div key={i}
                ...
                <div className="flex flex-col items-center justify-start pt-3.5 pb-3 px-2.5 gap-1 flex-shrink-0"
                  style={{ background: `${c}16`, borderRight: `1px solid ${c}20`, width: 56 }}>
                  <span className="font-black leading-none" style={{ fontSize: 34, color: c }}>{String(i + 1).padStart(2, '0')}</span>
                  <div className="h-px w-5 rounded-full" style={{ background: `${c}50` }} />
                </div>
                {/* Content */}
                <div className="flex-1 px-4 py-3 relative overflow-hidden" style={{ background: `${c}05` }}>
                  ...
                  {strong ? (
                    <>
                      <p className="font-extrabold text-sm leading-snug mb-1 relative z-10" style={{ color: c }}>{strong}</p>
                      <p className="text-white/55 text-xs leading-relaxed relative z-10">{rest}</p>
                    </>
                  ) : (
                    <p className="text-white/75 text-sm leading-relaxed relative z-10">{item}</p>
                  )}
                </div>
              </motion.div>
            )
          ...
          return (
            <motion.div key={i} initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }}
              ...
              <div className="flex items-center justify-center flex-shrink-0"
                style={{ width: 68, background: `${c}18`, borderRight: `1px solid ${c}22` }}>
                <span style={{ fontSize: 30 }}>{icon || <span className="font-black text-2xl" style={{ color: c }}>{i + 1}</span>}</span>
              </div>
              {/* Body */}
              <div className="flex-1 px-5 py-3.5 relative overflow-hidden" style={{ background: `${c}06` }}>
                ...
                <div className="relative z-10">
                  {strong && (
                    <span className="font-extrabold text-base" style={{ color: c }}>{strong}: </span>
                  )}
                  {isScript ? (
                    <span className="text-white/80 text-base font-mono leading-relaxed italic">{rest}</span>
                  ) : (
                    <span className="text-white/72 text-base leading-relaxed">{strong ? rest : item}</span>
                  )}
                </div>
              </div>
    ...
    return (
      <motion.div key={p.label} initial={{ opacity: 0, x: side === 'left' ? -16 : 16 }} animate={{ opacity: 1, x: 0 }}
        ...
        <div className="flex items-center gap-2 mb-2">
          ...
          <p className="text-base font-extrabold flex-1" style={{ color: p.highlight ? GREEN : 'white' }}>{p.label}</p>
          {p.highlight && (
        ...
        <p className="text-white/40 text-xs mb-2 leading-snug">{p.desc}</p>
            ...
            return (
              <div key={item} className="flex items-center gap-1.5">
                ...
                <span className="text-xs"
                  style={{ color: hl ? GREEN : 'rgba(255,255,255,0.62)', fontWeight: hl ? 700 : 400 }}>
                  {item}
                </span>
              </div>
            )
          ...
          return (
            <motion.div key={i}
              ...
              <p className="font-extrabold leading-none mb-1"
                style={{ fontSize: 32, color: stat.color }}>{stat.value}</p>
              <p className="text-xs text-white/45 leading-snug mb-3">{stat.label}</p>
              {bar ? (
                <div className="mt-auto">
                  ...
                  <p className="text-[11px] font-bold" style={{ color: `${stat.color}80` }}>{bar.label}</p>
                </div>
              ) : (
                <div className="mt-auto">
                  <p className="text-[11px] font-bold" style={{ color: `${stat.color}80` }}>
      ...
      <div className="grid grid-cols-2 gap-2">
        {slide.insights.map((insight, i) => (
          <motion.div key={i}
            ...
            <span style={{ color: GREEN, fontSize: 16, flexShrink: 0, marginTop: 1 }}>↗</span>
  ...
  return (
    <div className="flex flex-col justify-center h-full px-8 lg:px-16 max-w-4xl mx-auto w-full">
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.05 }}
        className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-sm font-bold mb-4 self-start"
        style={{ background: `${color}18`, border: `1px solid ${color}40`, color }}>
        {slide.platform}
      </motion.div>
      <SlideTitle>{slide.title}</SlideTitle>
      <motion.div initial={{ opacity: 0, y: 6 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}
        className="mt-3 mb-5 px-4 py-3.5 rounded-xl"
      ...
      <div className="grid grid-cols-2 gap-3">
        {slide.networks.map((net, i) => (
          <motion.div key={i} initial={{ opacity: 0, y: 14 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.25 + i * 0.09 }}
            ...
            <span className="text-2xl flex-shrink-0">{net.icon}</span>
            <div>
              <p className="text-base font-extrabold text-white mb-1">{net.name}</p>
              <p className="text-sm text-white/55 leading-relaxed">{net.desc}</p>
            </div>
          </motion.div>
        ))}
      </div>
      {slide.note && (
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.65 }}
          ...
          <p className="text-base font-semibold" style={{ color: GREEN }}>{slide.note}</p>
        </motion.div>
      )}
    </div>
  )
            ...
            {slide.leftZones.map((zone, zi) => (
              <div key={zi} className="flex flex-col items-center justify-center rounded-xl gap-0.5"
                ...
                <span className="font-extrabold text-center leading-tight"
                  style={{ color: zone.color, writingMode: 'vertical-lr', transform: 'rotate(180deg)', fontSize: 12, letterSpacing: '0.08em' }}>
                  {zone.label}
                </span>
                <span className="font-semibold text-center"
                  style={{ color: `${zone.color}70`, writingMode: 'vertical-lr', transform: 'rotate(180deg)', fontSize: 10 }}>
                  {zone.sub}
                </span>
              </div>
            ))}
        ...
        {slide.continuous && (
          <motion.div initial={{ opacity: 0, x: 14 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.7 }}
            ...
            <div className="flex flex-col items-center justify-center w-full rounded-xl gap-2"
              ...
              <span className="font-extrabold text-center leading-tight"
                style={{ color: GREEN, writingMode: 'vertical-lr', transform: 'rotate(180deg)', fontSize: 11, letterSpacing: '0.06em' }}>
                {slide.continuous}
              </span>
            </div>
          </motion.div>
        ...
        <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.88 }}
          ...
          {highlights.map((line, i) => (
            <div key={i} className="flex items-center gap-2 px-4 py-2.5 rounded-xl"
              ...
              <p className="text-white/80 text-sm font-semibold leading-snug">{line}</p>
            </div>
          ))}
        </motion.div>
      )}
          ...
          return (
            <div key={i} className="flex items-center gap-1.5">
              <motion.div
                ...
                <span className="text-white/90 text-base font-semibold whitespace-nowrap">{step}</span>
              </motion.div>
              {i < steps.length - 1 && (
    ...
    <div className="flex flex-col justify-center h-full px-8 lg:px-16 max-w-5xl mx-auto w-full">
      ...
      {slide.obs && (
        <motion.div initial={{ opacity: 0, y: 6 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.7 }}
          ...
          <p className="text-base text-white/65 leading-relaxed">{slide.obs}</p>
        </motion.div>
      )}
    </div>
  )
        ...
        {slide.cards.map((card, i) => {
          ...
          return (
            <motion.div key={i} initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }}
              ...
              <div>
                <p className="font-extrabold text-lg mb-1" style={{ color: c }}>{card.label}</p>
          ...
          {slide.events.map((ev, i) => {
            ...
            return (
              <motion.div key={i} initial={{ opacity: 0, x: -18 }} animate={{ opacity: 1, x: 0 }}
                ...
                {/* Time chip */}
                <div className="flex-shrink-0 w-[60px] h-[60px] rounded-2xl flex items-center justify-center z-10 text-center"
                  style={{ background: `${c}16`, border: `2px solid ${c}50`,
                           boxShadow: `0 0 14px ${c}18` }}>
                  <span className="text-xs font-extrabold leading-tight" style={{ color: c }}>{ev.time}</span>
                </div>
                {/* Card */}
                <div className="flex-1 py-3.5 px-4 rounded-xl"
                  style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.07)',
                           borderLeft: `3px solid ${c}50` }}>
                  <p className="text-white/85 text-base leading-relaxed">{ev.desc}</p>
                </div>
              </motion.div>
            )
          })}
    ...
    <div className="flex flex-col justify-center h-full px-8 lg:px-16 max-w-4xl mx-auto w-full">
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }}
          ...
          style={{ background: `${GREEN}08`, border: `1px solid ${GREEN}22` }}>
          <div>
            <p className="text-xs font-extrabold tracking-widest mb-4" style={{ color: `${GREEN}80` }}>EXEMPLO</p>
        ...
        {slide.points.map((p, i) => {
          ...
          return (
            <motion.div key={i} initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }}
              ...
              <span className="text-sm font-medium text-white/70 leading-snug">{p.text}</span>
            </motion.div>
          )
        })}
      </div>
...
function MissionsOverviewSlide({ slide }) {
  ...
  return (
    <div className="flex flex-col justify-center h-full px-8 lg:px-16 max-w-5xl mx-auto w-full">
      ...
      <div className={many ? 'grid grid-cols-2 gap-2' : 'space-y-2'}>
        {slide.missions.map((m, i) => (
          <motion.div key={i} initial={{ opacity: 0, x: -16 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.15 + i * 0.06 }}
            ...
            <div className="rounded-lg flex items-center justify-center flex-shrink-0 text-xs font-extrabold"
              style={{ width: many ? 42 : 50, height: many ? 42 : 50, background: `${GREEN}20`, border: `1px solid ${GREEN}40`, color: GREEN }}>
              Dia {m.day}
            </div>
            <span className="flex-shrink-0" style={{ fontSize: many ? '1rem' : '1.2rem' }}>{m.icon}</span>
            <div className="flex-1 min-w-0">
              <p className="font-bold text-white" style={{ fontSize: many ? '0.8rem' : '0.9rem' }}>{m.title}</p>
              <p className="text-white/45 mt-0.5" style={{ fontSize: '0.72rem' }}>Entregável: {m.evidence}</p>
            </div>
      ...
      <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.8 }}
        className="mt-3 text-white/35 text-sm text-center">
  ...
  return (
    <div className="flex flex-col justify-center h-full px-8 lg:px-14 max-w-4xl mx-auto w-full relative overflow-hidden">
      ...
      <div className="flex items-center gap-4 mb-5 relative z-10">
        ...
        <div>
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.08 }}
            ...
            <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-extrabold uppercase tracking-widest"
      ...
      <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.32 }}
        ...
        <div>
          <p className="text-xs font-extrabold uppercase tracking-widest mb-0.5" style={{ color: `${color}99` }}>
            Entregável obrigatório
          </p>
          <p className="text-base font-bold text-white/90">{slide.evidence}</p>
        </div>
      </motion.div>
      ...
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.55 }}
        ...
        <p className="text-sm text-white/45 italic leading-relaxed">{slide.why}</p>
      </motion.div>
    </div>
  )
}
